...
//   return (
//     <>
//       <div className="mt-10 p-8 flex justify-between">
//         <div>
...
//           <Card key={index} className="w-[400px] shadow-xl">
//             <CardHeader>
...
//         ))}
//       </div>
//       <div className="flex rounded-lg mt-10 p-10 justify-between">
//         <h1 className="font-bold text-2xl tracking-wider">Transactions</h1>
//         <div className="flex">
//           <div className="relative flex-grow">
//             <Input
//               className="mr-10 rounded-xl bg-gray-100"
...
const BorrowerPage = () => {
  ...
  return (
    <>
      <div className="mt-10 p-8 flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
        <div>
          <h1 className="font-bold text-xl">Hi Micheal Jackson</h1>
          <p>Welcome to BorrowPointe</p>
        </div>
